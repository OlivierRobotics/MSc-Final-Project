...
if __name__ == '__main__':
    ...
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.10, plane='xy')
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.10, plane='yz')
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.10, plane='xz')
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.15, plane='xy')
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.15, plane='yz')
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.15, plane='xz')
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.20, plane='xy')
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.20, plane='yz')
    #simple_circle_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/circle_tests_trpo01_20eps.csv', move_vel=0.5, radius=0.20, plane='xz')


    #simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.025, midpoint=[0, 0, 0], length=0.3, direction='x')
    #simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.05, midpoint=[0, 0, 0], length=0.3, direction='x')
    #simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.1, midpoint=[0, 0, 0], length=0.3, direction='x')
    #simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.025, midpoint=[0, 0, 0], length=0.3, direction='y')
    #simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.05, midpoint=[0, 0, 0], length=0.3, direction='y')
    #simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.1, midpoint=[0, 0, 0], length=0.3, direction='y')
    #simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.025, midpoint=[0, 0, 0], length=0.3, direction='z')
    #simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.05, midpoint=[0, 0, 0], length=0.3, direction='z')
    simple_line_test(20, 1, 'saved_policies/trpo01/trpo01', 'experiment_data/line_tests_trpo01_20eps.csv', move_vel=0.1, midpoint=[0, 0, 0], length=0.3, direction='z')
